...
public sealed class FeatureDialogService : IFeatureDialogService
{
    ...
    public void ShowExperimental(AndroidDevice device) => new ExperimentalWindow(device, _p3Capabilities, _gamepads, _inputBackend, _virtualDisplays, _lan, _remoteSessions, _automation, _audit, _embeddedSessions) { Owner = Application.Current.MainWindow }.Show();
